...
class DataIngestion:
    ...
    def export_collection_as_dataframe(self,collection_name,db_name):
        ...
        try:
            ...
            df.replace({"na":np.nan},inplacee = True)
    ...
    def __initiate_data_ingestion(self) -> Path:
        ...
        try:
            ...
            logging.info("got the data from mongobd")
            
            logging.info("excited initiate_data_ingestion methods of data ingestion class")
